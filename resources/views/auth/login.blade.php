                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">S'inscrire</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Connection</a>
                            </li>
                        </ul>
                                ...
                                <h3 class="register-heading">Form D'inscrire</h3>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group   {{$errors->first('password-confirm')?'has-danger':''}}">
                                            <input id="password-confirm" placeholder="Confirmer Votre Mot de passe *" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">                                            <p style="color: red ; display: none; " id="error"></p>
